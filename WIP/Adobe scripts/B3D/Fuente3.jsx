...
/**
 ...
 <h4>Usage</h4>
 <ol>
  <li>Run the sample in the ExtendScript Toolkit (see Readme.txt). You can choose as a target any application that supports ScriptUI, although it is recommended to choose Adobe Bridge CS3.
